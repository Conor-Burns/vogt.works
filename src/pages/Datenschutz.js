      ...
      <div className="wrapper">
        <div className="inner">
          ...
          <p>
            ...
            mitteilen. Hierbei kann es sich z.B.
            <br />
            um Daten handeln, die Sie in ein Kontaktformular eingeben.
            <br />
            Andere Daten werden automatisch beim Besuch der Website durch unsere
            IT-Systeme erfasst. Das sind
            <br />
            vor allem technische Daten (z.B. Internetbrowser, Betriebssystem
            oder Uhrzeit des Seitenaufrufs). Die
            <br />
          ...
          <p>
            ...
            außerdem ein Recht, die Berichtigung,
            <br />
